...
65
66
67</td><td class="line-coverage quiet"><span class="cline-any cline-yes">22x</span>
...
`;
&nbsp;
error['/server/options/noenv'] = <span class="fstat-no" title="function not covered" >({</span> name }) =&gt; <span class="cstat-no" title="statement not covered" >`</span>
  The option '${name}' cannot be passed through the environment of server.
  Please read the documentation for '${name}' and make sure to set it correctly.
`;
&nbsp;
error['/server/options/cannotextend'] = <span class="fstat-no" title="function not covered" >({</span> type, name }) =&gt; <span class="cstat-no" title="statement not covered" >`</span>
