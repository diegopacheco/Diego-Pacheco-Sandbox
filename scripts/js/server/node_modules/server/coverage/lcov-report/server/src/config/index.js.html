...
17
18
19</td><td class="line-coverage quiet"><span class="cline-any cline-yes">22x</span>
...
&nbsp;
  ...
  await Promise.all(plugins.map(async ({ name, options: def = <span class="branch-0 cbranch-no" title="branch not covered" >{}}</span> = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
