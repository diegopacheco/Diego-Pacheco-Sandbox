...
58
59
60</td><td class="line-coverage quiet"><span class="cline-any cline-yes">21x</span>
...
module.exports = {
  ...
  before: [
    ctx =&gt; ctx.options.security.csrf ? modern(csurf(ctx.options.security.csrf))(ctx) : <span class="branch-1 cbranch-no" title="branch not covered" >false,</span>
    ctx =&gt; {
