...
<html lang="en">
<head>
    <title>Code coverage report for src/config/errors.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/config</a> errors.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const error = require('../../error').defaults({
...
`;
&nbsp;
error['/server/options/noarg'] = <span class="fstat-no" title="function not covered" >({</span> key }) =&gt; <span class="cstat-no" title="statement not covered" >`</span>
...
`;
&nbsp;
error['/server/options/noenv'] = <span class="fstat-no" title="function not covered" >({</span> key }) =&gt; <span class="cstat-no" title="statement not covered" >`</span>
  The option '${key}' cannot be passed through the environment of server.
  Please read the documentation for '${key}' and make sure to set it correctly.
`;
&nbsp;
error['/server/options/cannotextend'] = <span class="fstat-no" title="function not covered" >({</span> type, key }) =&gt; <span class="cstat-no" title="statement not covered" >`</span>
